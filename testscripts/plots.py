...
plt.scatter(test_pca_new[:,0],test_pca_new[:,1])
...
plt.scatter(train_pca[:,0],train_pca[:,1])
plt.scatter(test_pca_new_sphere[:,0],test_pca_new_sphere[:,1])
plt.legend(['train_new','train_orig','test'])
plt.xlim((-0.1e-9, 2.5e-9))
plt.ylim((-0.1e-9,2.5e-9))
plt.xlabel('PCA dim 1')
...
plt.legend()
plt.savefig('figs/Morph_comparison_time') 
#%%
plt.scatter(train_morph[:,0],train_morph[:,1])
plt.scatter(test_morph[:,0],test_morph[:,1])
plt.legend(['train_new','train_orig','test'])
plt.xlim((-0.1e-9, 2.5e-9))
plt.ylim((-0.1e-9,2.5e-9))
plt.xlabel('PCA dim 1')
plt.ylabel('PCA dim 2')
plt.savefig('figs/morph_pca')
